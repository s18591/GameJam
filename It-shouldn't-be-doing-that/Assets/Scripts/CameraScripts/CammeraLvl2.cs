...
public class CammeraLvl2 : MonoBehaviour
{
    ...
    public float mapX = -0.36f;
    public float mapY = 0.7f;

    // just private var for the map boundaries
    private float minX = -6.84f;
    private float maxX = 3.88f;
    private float minY = 0.68f;
    private float maxY = 4.39f;
